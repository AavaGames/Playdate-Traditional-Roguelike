...
---@class DungeonPremade : Level
---@overload fun(theLevelManager: LevelManager, thePlayer: Player): DungeonPremade
DungeonPremade = class("DungeonPremade").extends("Level") or DungeonPremade

function DungeonPremade:init(theLevelManager, thePlayer)
    DungeonPremade.super.init(self, theLevelManager, thePlayer)
    ...
    DungeonPremade.super.finishInit(self)
end

function DungeonPremade:create()
